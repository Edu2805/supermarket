...
public class ProductData {
    ...
    @NotEmpty(message = "{br.com.supermarket.PRODUCT_DATA_FIELD_NAME_IS_NOT_EMPTY}")
    private String name;
    ...
    @NotNull(message = "{br.com.supermarket.PRODUCT_DATA_FIELD_INTERNAL_CODE_IS_NOT_EMPTY}")
