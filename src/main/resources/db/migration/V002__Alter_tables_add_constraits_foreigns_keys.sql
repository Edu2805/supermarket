...
ALTER TABLE IF EXISTS employee ADD CONSTRAINT foreign_key_department FOREIGN KEY (department) REFERENCES department (id);
ALTER TABLE IF EXISTS employee ADD CONSTRAINT foreign_key_job_position FOREIGN KEY (job_position) REFERENCES job_position (id);
ALTER TABLE IF EXISTS employee ADD CONSTRAINT foreign_key_user_data FOREIGN KEY (user_data) REFERENCES user_data (id);
